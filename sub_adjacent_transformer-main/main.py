...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='./sub_adjacent_transformer-main/dataset/creditcard_ts.csv')
    parser.add_argument('--model_save_path', type=str, default='./sub_adjacent_transformer-main/checkpoints')
    ...
    os.makedirs('./sub_adjacent_transformer-main/results', exist_ok=True)

    log_file = os.path.join('./sub_adjacent_transformer-main/logs', f'log-{config0.dataset}.log')
    logging.basicConfig(filename=log_file, filemode='a', level=logging.INFO,
                        format='%(asctime)s - %(levelname)s - %(message)s')

    gpu_state_file = os.path.join('./sub_adjacent_transformer-main/results', 'gpu_state.txt')
    ...
    if config0.record_state:
        ...
        # write into txt
        txt_file = os.path.join("./sub_adjacent_transformer-main/results", config0.dataset + '.txt')
